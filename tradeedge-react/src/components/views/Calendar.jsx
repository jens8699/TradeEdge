          ...
          {grid.map((cell, i) => {
            ...
            return (
              <div
                ...
                style={{
                  borderRadius: '8px',
                  border: isSelected ? '1.5px solid #E8724A' : `0.5px solid ${style.borderColor || 'rgba(255,255,255,0.06)'}`,
                  ...
                  position: 'relative',
                  outline: isToday ? '1.5px solid rgba(232,114,74,0.5)' : 'none',
                }}
              >
        ...
        <div className="jm-card" style={{ marginTop:'12px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'14px' }}>
            ...
            <div style={{ textAlign:'right' }}>
              <p style={{ fontSize:'22px', fontWeight:900, color: selData.pnl >= 0 ? '#5DCAA5' : '#F09595', margin:0 }}>
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:'8px' }}>
            {[...selData.list].sort((a,b) => (a.createdAt||'').localeCompare(b.createdAt||'')).map((t, i) => (
              <div key={t.id || i} style={{ display:'flex', justifyContent:'space-between', alignItems:'center', padding:'10px 12px', borderRadius:'8px', background:'rgba(255,255,255,0.03)', border:'0.5px solid rgba(255,255,255,0.06)' }}>
                ...
                <div style={{ textAlign:'right' }}>
                  <p style={{ fontSize:'14px', fontWeight:800, color: t.pnl > 0 ? '#5DCAA5' : t.pnl < 0 ? '#F09595' : '#8B8882', margin:'0 0 2px' }}>
                    {t.pnl >= 0 ? '+' : ''}{fmt(t.pnl)}
                  </p>
