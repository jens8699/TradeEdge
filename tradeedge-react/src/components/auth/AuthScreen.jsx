...
function LoginPanel({ onSwitch }) {
  ...
  return (
    <div className="tp-auth-card">
      ...
      <p className="tp-auth-sub">sign in to keep going.</p>
...
function RegisterPanel({ onSwitch }) {
  ...
  return (
    <div className="tp-auth-card">
      <p className="tp-auth-title">the journal for <em style={{ fontStyle: 'italic', color: '#E07A3B' }}>prop traders</em>.</p>
      <p className="tp-auth-sub">free forever. no card. upgrade when you want.</p>
      <div className="tp-auth-field"><label>your name</label>
        <input type="text" placeholder="your name or trading alias" autoComplete="name" value={name} onChange={e => setName(e.target.value)} /></div>
      ...
      <div className="tp-plans">
        ...
        >
          ...
          <div className="tp-plan-note">core journal · no card</div>
        </div>
        <div
...
function ResetPanel({ onSwitch }) {
  ...
  return (
    <div className="tp-auth-card">
      ...
      <p className="tp-auth-sub">send a reset link to your email.</p>
      <div className="tp-auth-field"><label>email</label>
        <input type="email" placeholder="you@example.com" autoComplete="email" value={email} onChange={e => setEmail(e.target.value)} /></div>
      <button className="tp-auth-btn" disabled={busy} onClick={submit}>
...
function NewPassPanel() {
  ...
  return (
    <div className="tp-auth-card">
      ...
      <p className="tp-auth-sub">pick a strong one.</p>
  ...
  return (
    <div className="screen-auth">
      <div className="tp-auth-wrap">
        ...
        <p className="tp-auth-tagline">© 2026 tradeedge · built by a prop trader, for prop traders</p>
      </div>
    </div>
  );
}
